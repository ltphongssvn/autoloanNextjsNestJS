...
vi.mock('../components/Toast', () => ({
  default: () => <div data-testid="mock-toast" />,
}));
...
describe('RootLayout', () => {
  ...
  it('should return html element with lang="en"', () => {
    const result = RootLayout({ children: <div>Test</div> }) as React.ReactElement;
  ...
  it('should render body with Tailwind classes', () => {
    ...
    expect(body.props.className).toContain('bg-gray-50');
  });

  it('should wrap children with AuthProvider, Navigation, and Toast', () => {
    ...
    expect(childrenArray.length).toBeGreaterThanOrEqual(2);
  });
});
